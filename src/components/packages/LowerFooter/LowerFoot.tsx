    ...
    <div className={` ${styles.mainWrapper}`}>
      <div className={styles.lowerWrap}>
        <div className={styles.sectWrap}>
          ...
          <Link href="https://www.webmoderna.ch/" target="_blank">
        ...
        <div className={styles.sectWrap}>
          ...
          <Link
            href="https://www.webmoderna.ch/"
            target="_blank"
            className={styles.link}
          >
            <p className={` ${styles.lighted}`}>Webmoderna.ch</p>
            <Image
              className={styles.logoIcon}
              src={logo}
              width={15}
              height={15}
              alt="Web Moderna Web Agency www.Webmoderna.ch"
            ></Image>
          </Link>
        </div>
